                       ...
                       <ul class="dropdown-menu dropdown-menu-end">
                           ...
                           <li>
                               <a class="dropdown-item" href="javascript:void(0);" data-language="de">
                                   <i class="fi fi-kn fis rounded-circle fs-4 me-1"></i>
                                   <span class="align-middle">Kenya</span>
                               </a>
                           </li>
                           <li>
                               <a class="dropdown-item" href="javascript:void(0);" data-language="pt">
                                   <i class="fi fi-za fis rounded-circle fs-4 me-1"></i>
                   ...
                   <li class="nav-item navbar-dropdown dropdown-user dropdown">
                       <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                           ...
                           <div class="avatar avatar-online">
                               <img src="{{ asset(Auth::guard('admin')->user()->avatar) }}" alt class="rounded-circle"
                       ...
                       <ul class="dropdown-menu dropdown-menu-end">
                           ...
                           <li>
                               <a class="dropdown-item" href="{{ route('admin.settingsPage') }}">
