@extends('onlinevendor.layouts.authlayout')
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('vendor.authenticate') }}" method="POST"  autocomplete="off">
                        @csrf
                        <div class="mb-3">
                            <label for="fullname" class="form-label">Full Name</label>
                            <input type="text" class="form-control" id="fullname" name="fullname"
                                placeholder="Enter your username" autofocus required value="{{ old('fullname') }}" autocomplete="false" />
                            @error('fullname')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email"
                                placeholder="Enter your email" required value="{{ old('email') }}" autocomplete="false" />
                            @error('email')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password" class="form-control" name="password"
                                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                    aria-describedby="password" required vvalue="{{ old('password') }}"autocomplete="off" />
                        ...
                        <div class="mb-3 ">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input class="form-control mobile-number" type="number" id="phone" name="phone"
                                    placeholder="202 555 0111" min="9" max="10" value="{{ old('phone') }}"
                                    required />
                            </div>
                            @error('phone')
                                <p class="error">{{ $message }}</p>
